...
async function fetchProduct(){
    ...
    document.getElementById("cont").innerHTML= ` <h4 style="color: rgb(123, 121, 121);margin-bottom: 15px;">${product.category}</h4>
    ...
    product.images.map((image)=>{
        str+=`<div class="thumbimg">
                <img src="${image}" alt="no-image" onmouseover="changePic('${image}')">
             </div>`
    })
    document.getElementById("thumbnail").innerHTML=str
